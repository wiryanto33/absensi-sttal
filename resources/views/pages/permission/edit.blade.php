        ...
        <section class="section">
            ...
            <div class="section-body">
                ...
                <p class="section-lead">
                    Perbarui informasi tentang izin Prajurit.
                </p>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="form-group col-md-6 col-12">
                                            <label>Nama Prajurit</label>
                                            <p>{{ $permission->prajurit->name }}</p>
                                        </div>
                                        <div class="form-group col-md-6 col-12">
                                            <label>Telpon Prajurit</label>
                                            <p>{{ $permission->prajurit->phone }}</p>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-6 col-12">
                                            ...
                                            <p>{{ $permission->prajurit->position }}</p>
                                        </div>
                                        <div class="form-group col-md-6 col-12">
                                            <label>Department</label>
                                            <p>{{ $permission->prajurit->department }}</p>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="form-group col-md-6 col-12">
